...
public final class T extends C0418x {
    ...
    public static T E(C0404i iVar, C0411p pVar) {
        return (T) C0418x.t(DEFAULT_INSTANCE, iVar, pVar);
    }

    public static void y(T t6, V v6) {
        t6.getClass();
        t6.params_ = v6;
    }

    public static void z(T t6, int i2) {
        t6.keySize_ = i2;
    }
