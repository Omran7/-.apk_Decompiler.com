...
public final class C0126p extends C0418x {
    private static final C0126p DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    private static volatile Y PARSER;
    private int ivSize_;

    /* JADX WARNING: type inference failed for: r0v0, types: [O2.p, com.google.crypto.tink.shaded.protobuf.x] */
    static {
        ? xVar = new C0418x();
        DEFAULT_INSTANCE = xVar;
        C0418x.v(C0126p.class, xVar);
    }

    public static C0125o B() {
        return (C0125o) DEFAULT_INSTANCE.j();
    }

    public static void y(C0126p pVar) {
        pVar.ivSize_ = 16;
    }

    public static C0126p z() {
