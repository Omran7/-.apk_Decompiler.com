...
public final class D extends C0418x {
    ...
    public static D B(C0404i iVar, C0411p pVar) {
        return (D) C0418x.t(DEFAULT_INSTANCE, iVar, pVar);
    }

    public static void y(D d, int i2) {
        d.keySize_ = i2;
    }
    ...
    public final Object k(int i2) {
        ...
        switch (C0928e.c(i2)) {
            ...
            case 1:
                return null;
            case 2:
                return new c0(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000b\u0002\u000b", new Object[]{"version_", "keySize_"});
            case 3:
                return new C0418x();
            case 4:
