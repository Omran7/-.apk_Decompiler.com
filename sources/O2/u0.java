...
public final class u0 extends C0418x {
    ...
    public static u0 D(C0404i iVar, C0411p pVar) {
        return (u0) C0418x.t(DEFAULT_INSTANCE, iVar, pVar);
    }
    ...
    public static void z(u0 u0Var, C0403h hVar) {
        u0Var.getClass();
        u0Var.keyValue_ = hVar;
    }
