...
public final class p0 extends C0418x {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [O2.p0, com.google.crypto.tink.shaded.protobuf.x] */
    static {
        ? xVar = new C0418x();
        DEFAULT_INSTANCE = xVar;
        C0418x.v(p0.class, xVar);
    }
    ...
    public static p0 D(C0404i iVar, C0411p pVar) {
        return (p0) C0418x.t(DEFAULT_INSTANCE, iVar, pVar);
    }
