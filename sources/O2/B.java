...
public final class B extends C0418x {
    ...
    public static B D(C0404i iVar, C0411p pVar) {
        return (B) C0418x.t(DEFAULT_INSTANCE, iVar, pVar);
    }

    public static void y(B b6) {
        b6.version_ = 0;
    }

    public static void z(B b6, C0403h hVar) {
        b6.getClass();
        b6.keyValue_ = hVar;
    }
