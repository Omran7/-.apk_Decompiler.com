...
public abstract class e {
    ...
    public static Intent a(C0518i iVar) {
        Intent parentActivityIntent = iVar.getParentActivityIntent();
        if (parentActivityIntent != null) {
            return parentActivityIntent;
        }
        try {
            String c3 = c(iVar, iVar.getComponentName());
            if (c3 == null) {
                return null;
            }
            ComponentName componentName = new ComponentName(iVar, c3);
            try {
    ...
    public static Intent b(C0518i iVar, ComponentName componentName) {
        String c3 = c(iVar, componentName);
        if (c3 == null) {
            return null;
        }
        ComponentName componentName2 = new ComponentName(componentName.getPackageName(), c3);
        if (c(iVar, componentName2) == null) {
    ...
    public static void d(android.content.Context r5, java.lang.String r6) {
        ...
        L_0x0060:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: z.e.d(android.content.Context, java.lang.String):void");
    }
    ...
    public static java.lang.String e(android.content.Context r8) {
        ...
        L_0x006c:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: z.e.e(android.content.Context):java.lang.String");
    }
}
