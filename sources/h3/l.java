...
public final class l implements Executor {
    ...
    public static final Logger f8145f = Logger.getLogger(l.class.getName());

    /* renamed from: a  reason: collision with root package name */
    public final Executor f8146a;

    /* renamed from: b  reason: collision with root package name */
    public final ArrayDeque f8147b = new ArrayDeque();
    ...
    public final a f8149e = new a(this);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
        r7.f8146a.execute(r7.f8149e);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0029, code lost:
        if (r7.f8148c == 2) goto L_0x002c;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0033, code lost:
        if (r7.d != r3) goto L_0x003e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0037, code lost:
        if (r7.f8148c != 2) goto L_0x003e;
     */
    ...
    public final void execute(java.lang.Runnable r8) {
        /*
            ...
            java.util.ArrayDeque r0 = r7.f8147b
            monitor-enter(r0)
            int r1 = r7.f8148c     // Catch:{ all -> 0x0066 }
            r2 = 4
            ...
            goto L_0x0068
        L_0x000f:
            long r3 = r7.d     // Catch:{ all -> 0x0066 }
            B0.a r1 = new B0.a     // Catch:{ all -> 0x0066 }
            r5 = 3
            r1.<init>(r8, r5)     // Catch:{ all -> 0x0066 }
            java.util.ArrayDeque r8 = r7.f8147b     // Catch:{ all -> 0x0066 }
            r8.add(r1)     // Catch:{ all -> 0x0066 }
            r8 = 2
            r7.f8148c = r8     // Catch:{ all -> 0x0066 }
            monitor-exit(r0)     // Catch:{ all -> 0x0066 }
            java.util.concurrent.Executor r0 = r7.f8146a     // Catch:{ RuntimeException -> 0x0044, Error -> 0x0042 }
            B2.a r5 = r7.f8149e     // Catch:{ RuntimeException -> 0x0044, Error -> 0x0042 }
        ...
        L_0x002c:
            java.util.ArrayDeque r0 = r7.f8147b
            monitor-enter(r0)
            long r5 = r7.d     // Catch:{ all -> 0x003c }
            int r1 = (r5 > r3 ? 1 : (r5 == r3 ? 0 : -1))
            if (r1 != 0) goto L_0x003e
            int r1 = r7.f8148c     // Catch:{ all -> 0x003c }
            if (r1 != r8) goto L_0x003e
            r7.f8148c = r2     // Catch:{ all -> 0x003c }
            goto L_0x003e
        L_0x003c:
            r8 = move-exception
            goto L_0x0040
        ...
        L_0x0044:
            r0 = move-exception
        L_0x0045:
            java.util.ArrayDeque r2 = r7.f8147b
            monitor-enter(r2)
            int r3 = r7.f8148c     // Catch:{ all -> 0x0061 }
            r4 = 1
            if (r3 == r4) goto L_0x004f
            if (r3 != r8) goto L_0x0058
        L_0x004f:
            java.util.ArrayDeque r8 = r7.f8147b     // Catch:{ all -> 0x0061 }
        ...
        L_0x0066:
            ...
            goto L_0x006f
        L_0x0068:
            java.util.ArrayDeque r1 = r7.f8147b     // Catch:{ all -> 0x0066 }
        ...
        L_0x006f:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: h3.l.execute(java.lang.Runnable):void");
    }

    public final String toString() {
        return "SequentialExecutor@" + System.identityHashCode(this) + "{" + this.f8146a + "}";
    }
}
