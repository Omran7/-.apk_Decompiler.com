...
final class zzpv {
    ...
    public static String zzd(byte[] bArr, int i2, int i5) {
        int i6;
        int length = bArr.length;
        if ((((length - i2) - i5) | i2 | i5) >= 0) {
            int i7 = i2 + i5;
                ...
                if (zzpt.zzd(b7)) {
                    ...
                    if (b7 < -32) {
                        ...
                        if (i10 < i7 - 1) {
                            ...
                            int i11 = r10 + 2;
                            r10 = r10 + 3;
                            zzpt.zzb(b7, bArr[i10], bArr[i11], cArr, i9);
                        } else {
                            throw new zznn("Protocol message had invalid UTF-8.");
                        }
                    } else if (i10 < i7 - 2) {
                        ...
                        byte b10 = bArr[r10 + 2];
                        r10 += 4;
                        zzpt.zza(b7, b9, b10, bArr[i12], cArr, i9);
                        i9 += 2;
                    } else {
                        throw new zznn("Protocol message had invalid UTF-8.");
                    }
