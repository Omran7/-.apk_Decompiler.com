...
final class zzmi extends zzkr implements RandomAccess, zznk, zzor {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (f.API_PRIORITY_OTHER - i5 >= i2) {
            ...
            System.arraycopy(zzmi.zzb, 0, this.zzb, this.zzc, zzmi.zzc);
            this.zzc = i6;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzmi zzmi = (zzmi) obj;
        if (this.zzc != zzmi.zzc) {
            return false;
        }
        double[] dArr = zzmi.zzb;
    ...
    public final /* bridge */ /* synthetic */ zznk zzd(int i2) {
        ...
        if (i2 >= this.zzc) {
            ...
            return new zzmi(dArr, this.zzc, true);
        }
    ...
    private zzmi(double[] dArr, int i2, boolean z3) {
        super(z3);
        this.zzb = dArr;
        this.zzc = i2;
    }
