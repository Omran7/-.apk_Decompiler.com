...
public final class Tasks {
    ...
    public static <TResult> TResult await(Task<TResult> task) {
        I.f("Must not be called on the main application thread");
    ...
    public static <T> Task<T> withTimeout(Task<T> task, long j6, TimeUnit timeUnit) {
        boolean z3;
        I.h(task, "Task must not be null");
        if (j6 > 0) {
            z3 = true;
        ...
        I.a("Timeout must be positive", z3);
        I.h(timeUnit, "TimeUnit must not be null");
        zzb zzb = new zzb();
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource(zzb);
        zza zza = new zza(Looper.getMainLooper());
        zza.postDelayed(new zzx(taskCompletionSource), timeUnit.toMillis(j6));
    ...
    public static <TResult> Task<TResult> call(Executor executor, Callable<TResult> callable) {
        I.h(executor, "Executor must not be null");
        I.h(callable, "Callback must not be null");
        zzw zzw = new zzw();
    ...
    public static <TResult> TResult await(Task<TResult> task, long j6, TimeUnit timeUnit) {
        I.f("Must not be called on the main application thread");
        Looper myLooper = Looper.myLooper();
        if (myLooper == null || !Objects.equals(myLooper.getThread().getName(), "GoogleApiHandler")) {
            I.h(task, "Task must not be null");
