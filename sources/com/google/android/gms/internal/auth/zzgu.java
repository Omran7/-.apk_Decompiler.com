...
class zzgu extends AbstractMap {
    ...
    public /* synthetic */ zzgu(int i2, zzgt zzgt) {
        this.zza = i2;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i5 = 0;
        if (i2 >= 0) {
            int compareTo = comparable.compareTo(((zzgo) this.zzb.get(i2)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
    ...
    public final int hashCode() {
        ...
        for (int i5 = 0; i5 < zzb2; i5++) {
            i2 += ((zzgo) this.zzb.get(i5)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i5 = this.zza;
        if (size == i5) {
            zzgo zzgo = (zzgo) this.zzb.remove(i5 - 1);
