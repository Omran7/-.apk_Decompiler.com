...
final class zzds {
    public static final zzdr zza(InputStream inputStream, zzdu zzdu) {
        try {
                ...
                try {
                    ...
                    if (zzb == Byte.MIN_VALUE) {
                        ...
                        if (zza2 <= 1000) {
                            ...
                            while (((long) i2) < zza2) {
                                zzdrArr[i2] = zzb(inputStream, zzdu);
                                i2++;
                            }
                        ...
                        if (zzc <= 1000) {
                            ...
                            while (((long) i6) < zzc) {
                                ...
                                zzdnArr[i6] = new zzdn(zzb2, zzb(inputStream, zzdu));
                                i6++;
                                zzdr = zzb2;
                            }
                            TreeMap treeMap = new TreeMap();
                            while (i2 < i5) {
                                zzdn zzdn = zzdnArr[i2];
    ...
    private static final void zzc(byte b6, long j6, InputStream inputStream, zzdu zzdu) {
        switch (b6) {
            case 24:
                if (j6 < 24) {
                    throw new zzdh("Integer value " + j6 + " after add info could have been represented in 0 additional bytes, but used 1");
                }
                return;
            case 25:
                if (j6 < 256) {
                    throw new zzdh("Integer value " + j6 + " after add info could have been represented in 0-1 additional bytes, but used 2");
                }
                return;
            case 26:
                if (j6 < 65536) {
                    throw new zzdh("Integer value " + j6 + " after add info could have been represented in 0-2 additional bytes, but used 4");
                }
                return;
            case 27:
                if (j6 < 4294967296L) {
                    throw new zzdh("Integer value " + j6 + " after add info could have been represented in 0-4 additional bytes, but used 8");
                }
                return;
            default:
                return;
