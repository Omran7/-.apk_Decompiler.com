...
public final class zzpd implements zzpc {
    ...
    static {
        ...
        zze = zza2.zzd("measurement.config.cache_time", 86400000);
        ...
        zzy = zza2.zzd("measurement.monitoring.sample_period_millis", 86400000);
        ...
        zzS = zza2.zzd("measurement.upload.stale_data_deletion_interval", 86400000);
