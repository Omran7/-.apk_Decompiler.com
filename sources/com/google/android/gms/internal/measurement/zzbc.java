...
public final class zzbc extends zzaw {
    ...
    public final zzap zza(String str, zzg zzg, List list) {
        ...
        if (ordinal == 1) {
            zzap zzb = zzg.zzb((zzap) C0552a.j(zzbl.AND, 2, list, 0));
            if (!zzb.zzg().booleanValue()) {
                return zzb;
            }
            return zzg.zzb((zzap) list.get(1));
        } else if (ordinal == 47) {
            return new zzaf(Boolean.valueOf(!zzg.zzb((zzap) C0552a.j(zzbl.NOT, 1, list, 0)).zzg().booleanValue()));
        } else {
            if (ordinal != 50) {
                return zzb(str);
            }
            zzap zzb2 = zzg.zzb((zzap) C0552a.j(zzbl.OR, 2, list, 0));
