...
final class zzkt {
    ...
    public static int zza(byte[] bArr, int i2, zzks zzks) {
    ...
    public static int zzc(zzns zzns, byte[] bArr, int i2, int i5, int i6, zzks zzks) {
        Object zze = zzns.zze();
        int zzl = zzl(zze, zzns, bArr, i2, i5, i6, zzks);
        zzns.zzf(zze);
        zzks.zzc = zze;
        return zzl;
    }

    public static int zzd(zzns zzns, byte[] bArr, int i2, int i5, zzks zzks) {
        Object zze = zzns.zze();
        int zzm = zzm(zze, zzns, bArr, i2, i5, zzks);
        zzns.zzf(zze);
        zzks.zzc = zze;
        return zzm;
    }

    public static int zze(zzns zzns, int i2, byte[] bArr, int i5, int i6, zzmj zzmj, zzks zzks) {
        int zzd = zzd(zzns, bArr, i5, i6, zzks);
        zzmj.add(zzks.zzc);
        while (zzd < i6) {
            ...
            zzd = zzd(zzns, bArr, zzh, i6, zzks);
            zzmj.add(zzks.zzc);
        }
        return zzd;
    }

    public static int zzf(byte[] bArr, int i2, zzmj zzmj, zzks zzks) {
        zzme zzme = (zzme) zzmj;
        int zzh = zzh(bArr, i2, zzks);
        int i5 = zzks.zza + zzh;
        while (zzh < i5) {
    ...
    public static int zzg(int i2, byte[] bArr, int i5, int i6, zzof zzof, zzks zzks) {
        if ((i2 >>> 3) != 0) {
            int i7 = i2 & 7;
            if (i7 == 0) {
                int zzk = zzk(bArr, i5, zzks);
                zzof.zzj(i2, Long.valueOf(zzks.zzb));
                return zzk;
            } else if (i7 == 1) {
                zzof.zzj(i2, Long.valueOf(zzn(bArr, i5)));
                return i5 + 8;
            } else if (i7 == 2) {
                int zzh = zzh(bArr, i5, zzks);
                int i8 = zzks.zza;
                if (i8 < 0) {
                    throw new zzmm("CodedInputStream encountered an embedded string or message which claimed to have negative size.");
                } else if (i8 <= bArr.length - zzh) {
                    if (i8 == 0) {
                        zzof.zzj(i2, zzld.zzb);
                    } else {
                        zzof.zzj(i2, zzld.zzj(bArr, zzh, i8));
                    }
                    return zzh + i8;
                } else {
                    throw new zzmm("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
                ...
                while (true) {
                    ...
                    int zzh2 = zzh(bArr, i5, zzks);
                    i11 = zzks.zza;
                    if (i11 == i9) {
                        i5 = zzh2;
                        break;
                    }
                    i5 = zzg(i11, bArr, zzh2, i6, zzf, zzks);
                }
                zzks.zze--;
                if (i5 > i6 || i11 != i9) {
                ...
                zzof.zzj(i2, Integer.valueOf(zzb(bArr, i5)));
                return i5 + 4;
            } else {
    ...
    public static int zzh(byte[] bArr, int i2, zzks zzks) {
        int i5 = i2 + 1;
        byte b6 = bArr[i2];
        if (b6 < 0) {
            return zzi(b6, bArr, i5, zzks);
        }
        zzks.zza = b6;
        return i5;
    }

    public static int zzi(int i2, byte[] bArr, int i5, zzks zzks) {
        byte b6 = bArr[i5];
        int i6 = i5 + 1;
        int i7 = i2 & 127;
        if (b6 >= 0) {
    ...
    public static int zzj(int i2, byte[] bArr, int i5, int i6, zzmj zzmj, zzks zzks) {
        zzme zzme = (zzme) zzmj;
        int zzh = zzh(bArr, i5, zzks);
        zzme.zzh(zzks.zza);
        while (zzh < i6) {
    ...
    public static int zzk(byte[] bArr, int i2, zzks zzks) {
    ...
    public static int zzl(Object obj, zzns zzns, byte[] bArr, int i2, int i5, int i6, zzks zzks) {
        int i7 = zzks.zze + 1;
        zzks.zze = i7;
        zzo(i7);
        int zzc = ((zznk) zzns).zzc(obj, bArr, i2, i5, i6, zzks);
        zzks.zze--;
        zzks.zzc = obj;
        return zzc;
    }
    ...
    public static int zzm(java.lang.Object r6, com.google.android.gms.internal.measurement.zzns r7, byte[] r8, int r9, int r10, com.google.android.gms.internal.measurement.zzks r11) {
        /*
            int r0 = r9 + 1
            byte r9 = r8[r9]
