...
final class zzlu {
    ...
    public static int zza(zzop zzop, int i2, Object obj) {
        zzlk.zzz(i2 << 3);
        if (zzop.GROUP == null) {
            byte[] bArr = zzmk.zzb;
    ...
    public static int zzb(zzlt zzlt, Object obj) {
        ...
        if (!zzlt.zzd()) {
            ...
            if (size <= 0) {
                return zzlk.zzz(0) + zzlk.zzz(zza2 << 3);
            }
            list.get(0);
    ...
    private static final int zzk(Map.Entry entry) {
        ...
        if (value instanceof zzmr) {
            ...
            int zzz2 = zzlk.zzz(8);
            i2 = zzz2 + zzz2;
            zzz = zzlk.zzz(zza2) + zzlk.zzz(16);
            int zzz3 = zzlk.zzz(24);
            int zza3 = ((zzmr) value).zza();
            a6 = a.a(zza3, zza3, zzz3);
        } else {
            int zza4 = ((zzlt) entry.getKey()).zza();
            int zzz4 = zzlk.zzz(8);
            i2 = zzz4 + zzz4;
            zzz = zzlk.zzz(zza4) + zzlk.zzz(16);
            int zzz5 = zzlk.zzz(24);
            int zzcf = ((zznh) value).zzcf();
            a6 = a.a(zzcf, zzcf, zzz5);
        }
        return i2 + zzz + a6;
    }
    ...
    public final void zzf() {
        if (!this.zzc) {
            ...
            int zzc2 = zzoa.zzc();
            for (int i2 = 0; i2 < zzc2; i2++) {
                Object value = zzoa.zzg(i2).getValue();
