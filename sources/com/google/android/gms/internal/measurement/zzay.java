...
public final class zzay extends zzaw {
    ...
    private static boolean zzc(zzap zzap, zzap zzap2) {
        if (zzap.getClass().equals(zzap2.getClass())) {
            ...
            boolean z3 = zzap instanceof zzah;
            if (z3 && (zzap2 instanceof zzat)) {
                return zzc(zzap, new zzah(zzap2.zzh()));
            }
            boolean z4 = zzap instanceof zzat;
            if (z4 && (zzap2 instanceof zzah)) {
            ...
            if ((z4 || z3) && (zzap2 instanceof zzal)) {
    ...
    private static boolean zzd(zzap zzap, zzap zzap2) {
        ...
        if (!(zzap instanceof zzat) || !(zzap2 instanceof zzat)) {
            ...
            if (Double.isNaN(doubleValue) || Double.isNaN(doubleValue2) || ((doubleValue == 0.0d && doubleValue2 == 0.0d) || ((i2 == 0 && doubleValue2 == 0.0d) || Double.compare(doubleValue, doubleValue2) >= 0))) {
                return false;
            }
            return true;
