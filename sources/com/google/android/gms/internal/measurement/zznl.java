...
final class zznl implements zzns {
    ...
    public static zznl zzc(zzoe zzoe, zzlq zzlq, zznh zznh) {
    ...
    public final int zzb(Object obj) {
        ...
        if (this.zzc) {
            return (hashCode * 53) + ((zzma) obj).zzb.zza.hashCode();
        }
        return hashCode;
    }
    ...
    public final void zzi(Object obj, zzor zzor) {
