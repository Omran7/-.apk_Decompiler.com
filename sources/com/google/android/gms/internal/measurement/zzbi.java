...
public final class zzbi extends zzaw {
    ...
    public final zzap zza(String str, zzg zzg, List list) {
        ...
        if (ordinal == 0) {
            zzap zzb = zzg.zzb((zzap) C0552a.j(zzbl.ADD, 2, list, 0));
            ...
            return new zzah(Double.valueOf(zzg.zzb((zzap) C0552a.j(zzbl.DIVIDE, 2, list, 0)).zzh().doubleValue() / zzg.zzb((zzap) list.get(1)).zzh().doubleValue()));
        } else {
            if (ordinal == 59) {
                zzap zzb3 = zzg.zzb((zzap) C0552a.j(zzbl.SUBTRACT, 2, list, 0));
                ...
                switch (ordinal) {
                    case 44:
                        return new zzah(Double.valueOf(zzg.zzb((zzap) C0552a.j(zzbl.MODULUS, 2, list, 0)).zzh().doubleValue() % zzg.zzb((zzap) list.get(1)).zzh().doubleValue()));
                    case 45:
                        return new zzah(Double.valueOf(zzg.zzb((zzap) list.get(1)).zzh().doubleValue() * zzg.zzb((zzap) C0552a.j(zzbl.MULTIPLY, 2, list, 0)).zzh().doubleValue()));
                    case 46:
                        return new zzah(Double.valueOf(-zzg.zzb((zzap) C0552a.j(zzbl.NEGATE, 1, list, 0)).zzh().doubleValue()));
                    default:
                        return zzb(str);
                }
            }
