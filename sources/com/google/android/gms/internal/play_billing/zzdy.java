...
public abstract class zzdy<V> extends zzfi implements zzeu<V> {
    ...
    abstract class zza {
        public /* synthetic */ zza(zzeb zzeb) {
        }
    ...
    final class zzf<V> implements Runnable {
        ...
        public zzf(zzdy zzdy, zzeu zzeu) {
            this.zza = zzdy;
            this.zzb = zzeu;
        }
    ...
    final class zzj extends zza {
        ...
        /*  JADX ERROR: StackOverflow in pass: RegionMakerVisitor
            ...
            */
        public final com.google.android.gms.internal.play_billing.zzdy.zzd zza(com.google.android.gms.internal.play_billing.zzdy r3, com.google.android.gms.internal.play_billing.zzdy.zzd r4) {
            /*
                r2 = this;
            L_0x0000:
        ...
        /*  JADX ERROR: StackOverflow in pass: RegionMakerVisitor
            jadx.core.utils.exceptions.JadxOverflowException: 
            	...
            	at jadx.core.utils.ErrorsCounter.methodError(ErrorsCounter.java:81)
            */
        public final com.google.android.gms.internal.play_billing.zzdy.zzk zzb(com.google.android.gms.internal.play_billing.zzdy r3, com.google.android.gms.internal.play_billing.zzdy.zzk r4) {
            /*
                r2 = this;
            L_0x0000:
        ...
        public /* synthetic */ zzj(zzeb zzeb) {
            super((zzeb) null);
        }
    }
    ...
    static {
        ...
        if (th != null) {
            ...
            zzet.zza().logp(level, "com.google.common.util.concurrent.AbstractFuture", "<clinit>", "SafeAtomicHelper is broken!", th);
        }
    }
    ...
    public static Object zzr(zzeu zzeu) {
        ...
        if (zzeu instanceof zzh) {
            ...
            try {
                Object zzs = zzs(zzeu);
                if (isCancelled) {
                    return new zzb(false, new IllegalArgumentException("get() did not throw CancellationException, despite reporting isCancelled() == true: ".concat(String.valueOf(zzeu))));
                }
                if (zzs == null) {
                    return zzd;
                }
                ...
                if (isCancelled) {
                    return new zzb(false, new IllegalArgumentException("get() did not throw CancellationException, despite reporting isCancelled() == true: ".concat(String.valueOf(zzeu)), e6));
                }
                return new zzc(e6.getCause());
            } catch (CancellationException e7) {
                if (!isCancelled) {
                    return new zzc(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: ".concat(String.valueOf(zzeu)), e7));
                }
    ...
    /* access modifiers changed from: private */
    public static void zzw(zzdy<V> zzdy, boolean z3) {
        zzd zzd2 = null;
        while (true) {
    ...
    private static void zzx(Runnable runnable, Executor executor) {
        try {
            ...
            zzb.zza().logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "executeListener", C0552a.p("RuntimeException while executing runnable ", String.valueOf(runnable), " with executor ", String.valueOf(executor)), e6);
        }
    }
    ...
    public final Object get(long j6, TimeUnit timeUnit) {
        ...
        if (!Thread.interrupted()) {
            ...
            throw new TimeoutException(d.g(str, " for ", zzdy));
        }
        throw new InterruptedException();
    }
}
