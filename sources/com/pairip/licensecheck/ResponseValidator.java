...
public class ResponseValidator {
    ...
    private static JSONObject base64ToJson(String str) throws LicenseCheckException {
        try {
            ...
            throw new LicenseCheckException("Invalid response", e6);
        }
    }
    ...
    private static void verifySignature(String str, String str2, String str3, PublicKey publicKey) throws LicenseCheckException {
        try {
            ...
            throw new LicenseCheckException(String.format("Could not find %s algorithm on the device", new Object[]{str3}), e6);
    ...
    private static PublicKey getPublicKey() throws LicenseCheckException {
        try {
            ...
            throw new LicenseCheckException(String.format("%s algorithm not found on device", new Object[]{KEY_FACTORY_ALGORITHM}), e6);
