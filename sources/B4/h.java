...
public final class h extends Number {
    ...
    public final double doubleValue() {
        return Double.parseDouble(this.f5529a);
    }
    ...
    public final float floatValue() {
        return Float.parseFloat(this.f5529a);
    }
    ...
    public final int intValue() {
        ...
        L_0x000d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: b4.h.intValue():int");
    }
