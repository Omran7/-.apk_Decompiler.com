...
public abstract class I {
    ...
    public static final long f2635a = TimeUnit.MINUTES.toMillis(1);

    /* renamed from: b  reason: collision with root package name */
    public static final Object f2636b = new Object();

    /* renamed from: c  reason: collision with root package name */
    public static a f2637c;

    public static void a(Context context) {
        if (f2637c == null) {
            a aVar = new a(context);
            f2637c = aVar;
            synchronized (aVar.f4178a) {
                aVar.g = true;
            }
        }
    }
    ...
    public static void b(Intent intent) {
        synchronized (f2636b) {
            try {
                if (f2637c != null && intent.getBooleanExtra("com.google.firebase.iid.WakeLockHolder.wakefulintent", false)) {
    ...
    public static android.content.ComponentName c(android.content.Context r4, android.content.Intent r5) {
        ...
        L_0x001e:
            ...
            X1.a r5 = f2637c     // Catch:{ all -> 0x001c }
            long r1 = f2635a     // Catch:{ all -> 0x001c }
        ...
        L_0x0029:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: S3.I.c(android.content.Context, android.content.Intent):android.content.ComponentName");
    }
}
