...
public class C0750z extends ImageView {

    /* renamed from: a  reason: collision with root package name */
    public final C0730p f9427a;
    ...
    public C0750z(Context context, AttributeSet attributeSet, int i2) {
    ...
    public final boolean hasOverlappingRendering() {
        if ((((ImageView) this.f9428b.f30c).getBackground() instanceof RippleDrawable) || !super.hasOverlappingRendering()) {
            return false;
        }
        return true;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        f fVar = this.f9428b;
        if (!(fVar == null || drawable == null || this.f9429c)) {
